...
objfs automatically registers the local machine as a worker in the NativeLink cluster. Every machine running objfs contributes to the shared build capacity.
